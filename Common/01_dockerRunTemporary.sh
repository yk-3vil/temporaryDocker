...
#
# 使用方法:
#   - 各imageディレクトリから: ../Common/01_dockerRunTemporary.sh env_openjdk_21_0_9.sh
#   - プロジェクトルートから: ./Common/01_dockerRunTemporary.sh openjdk_21.0.9/env_openjdk_21_0_9.sh
...
if [[ $# -ne 1 ]]; then
  ...
  echo "  ../Common/01_dockerRunTemporary.sh env_openjdk_21_0_9.sh"
  echo ""
  echo "例（プロジェクトルートから）:"
  echo "  ./Common/01_dockerRunTemporary.sh openjdk_21.0.9/env_openjdk_21_0_9.sh"
  exit 1
fi
