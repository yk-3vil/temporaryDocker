...
#
# 使用方法:
#   - 各imageディレクトリから: ../Common/02_dockerRunDetached.sh env_ubuntu_24_04.sh
#   - プロジェクトルートから: ./Common/02_dockerRunDetached.sh ubuntu_24.04/env_ubuntu_24_04.sh
...
if [[ $# -ne 1 ]]; then
  ...
  echo "  ../Common/02_dockerRunDetached.sh env_ubuntu_24_04.sh"
  echo ""
  echo "例（プロジェクトルートから）:"
  echo "  ./Common/02_dockerRunDetached.sh ubuntu_24.04/env_ubuntu_24_04.sh"
  exit 1
fi
